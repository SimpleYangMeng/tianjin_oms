...
<!--多选select 样式-->
<link href="/select-multiple/css/select-multiple.css" media="screen" rel="stylesheet" type="text/css" />
<!-- -->
<script type="text/javascript" src="/select-multiple/js/jquery.quicksearch.js"></script>
<style>
...
#item_table { width: 660px; margin-left: 50px; }
#item_table input.text-input { width: 158px; }
#agent_id, #agent_id-k { display: block; }
#agent_id p.form-p, #agent_id-k p.form-p { width: 100%; }
.ms-container { margin: 0; width: 560px; float: left;}
.custom-header { color: #0088CC; }
ul.ms-list { margin-top: 4px; }
#search-input { padding: 6px; width: 260px; border-radius: 4px; }
</style>
        ...
        <form id="registerForm" class="fm-layout"  style="margin-top:10px;" method="post" action="/register/complete" >
            <fieldset>
                ...
                <p class="form-p">
                    ...
                    <select id="ciqOrgTypeCode" name="ciqOrgTypeCode" class="text-input2" style="width:195px">
                        <option value="">请选择...</option>
                        <{foreach from=$organizations item=coitem name=coitem key=key}>
                            <option value="<{$coitem.organization_code}>" selected="selected"><{$coitem.organization_name}></option>
                        <{/foreach}>
                        <!--
                ...
                -->
                <p class="form-p">
                    <label class="form-label"><{t}>企业名称<{/t}>：</label>
                    <input class="text-input" type="text" id="trade_name" name="trade_name">
                    <strong class="form-strong">*</strong>
                </p>
                <p class="form-p">
                    <label class="form-label"><{t}>企业英文名称<{/t}>：</label>
            ...
            <!-- <table cellspacing="0" cellpadding="0" class="tableborder formtable" id='item_table'>
                ...
                <p class="form-p">
                    ...
                    <label class="fb_label" style="margin-right: 0px"><input id="business_type-b" name="business_type[]" val="business_type" type="checkbox" value="2"><span>保税出口</span></label>
                    <strong class="form-strong">*</strong>
                </p>
                <!--<p class="form-p">
                ...
                <!-- 代理select begin -->
                <div id="agent_id" class="cl" style="display:none;">
                    <p class="form-p cl">
                        <label class="form-label">代理申报单位：</label>
                        <select id="agent" name="agent[]" class="text-input2" multiple="multiple" size="3">
                            <{if $agent neq ""}>
                            <{foreach from=$agent item=item}>
                                <option value="<{$item['customer_code']}>-<{$item['trade_name']}>"><{$item['trade_name']}>【<{$item['customer_code']}>】</option>
                                <{/foreach}>
                            <{/if}>
                        </select>
                    </p>
                ...
                <!--
                <div id="agent_id-k" class="cl" style="display:none;">
                    <p class="form-p cl">
                        <label class="form-label">代理申报单位：</label>
                        <select id="agen-k" name="agent-k[]" class="text-input2" multiple="multiple" size="3">
                            <{if $agent neq ""}>
                            <{foreach from=$agent item=item}>
                                <option value="<{$item['customer_code']}>"><{$item['trade_name']}>【<{$item['customer_code']}>】</option>
                                <{/foreach}>
                            <{/if}>
                        </select>
                    </p>
               ...
               <!--  <p class="form-p">
                ...
                <p class="form-p" style="width: 100%; text-align: center;">
                    <input type="button" class="button text-input" value="确认提交" style="width:80px;" id="registersub">
                </p>
				<div class="clear"></div>
            </fieldset>
...
$(function(){
    ...
    $('#customertype').change(function(){ 
        ...
        if(opt_val == 1){
            ...
            $("#block").html('<table cellspacing="0" cellpadding="0" class="tableborder formtable" id="item_table"><thead><tr id="error" style="display:none"><td colspan="12" id="product-table-message_tip" class="error"></td></tr><tr><td>电商平台网站</td><td>网店名称</td><td>经营商品</td><td>操作<img src="/images/plus_sign.gif"style="margin-left:8px;cursor: pointer;" onclick="addProduct()"/></td></tr></thead><tr class="son-tr"><td><input class="text-input" type="text" id="bus_web_address" name="bus_web_address[]"> <strong class="form-strong">*</strong></td><td><input class="text-input" type="text" id="eshop_name" name="eshop_name[]"> <strong class="form-strong">*</strong></td><td><input class="text-input" type="text" id="bus_scope" name="bus_scope[]"> <strong class="form-strong">*</strong></td><td><img src="/images/minus_sign.gif" style="margin-left:8px;margin-top:5px;position:absolute;cursor: pointer;" onclick="deleteProudt(this)"></td></tr></table><p class="form-p"><label class="form-label">ICP备案号：</label><input class="text-input" type="text" id="cn_icp_code" name="cn_icp_code"> <strong class="form-strong">*</strong></p>');
            /*
        ...
        if(opt_val == 6){
            ...
            $("#block-k").html('<table cellspacing="0" cellpadding="0" class="tableborder formtable" id="item_table"><thead><tr id="error" style="display:none"><td colspan="12" id="product-table-message_tip" class="error"></td></tr><tr><td>电商平台网站</td><td>网店名称</td><td>经营商品</td><td>操作 <img src="/images/plus_sign.gif"style="margin-left:8px;cursor: pointer;" onclick="addProduct()"/></td></tr></thead><tr class="son-tr"><td><input class="text-input" type="text" id="bus_web_address" name="bus_web_address[]"> <strong class="form-strong">*</strong></td><td><input class="text-input" type="text" id="eshop_name" name="eshop_name[]"> <strong class="form-strong">*</strong></td><td><input class="text-input" type="text" id="bus_scope" name="bus_scope[]"> <strong class="form-strong">*</strong></td><td><img src="/images/minus_sign.gif" style="margin-left:8px;margin-top:5px;position:absolute;cursor: pointer;" onclick="deleteProudt(this)"></td></tr></table><p class="form-p"><label class="form-label">ICP备案号：</label><input class="text-input" type="text" id="cn_icp_code" name="cn_icp_code"> <strong class="form-strong">*</strong></p>');
            /*
        ...
        /*$('#customs_reg_num').off('blur');
        if(opt_val == 7){
            $('#customs_reg_num').on('blur',baoguancheck);
        }*/
    }).change();
...
function checkForm(){
    ...
    */
    ...
    if(opt_val == 1){
        ...
        */
        if($('#agent').find("option:selected").length < 1){
            alertTip("请选择代理报关企业");
            return false;
        }
        if(bus_web_address==""){
...
//添加电商网址
function addProduct(){
    if($('#item_table tr.son-tr').length > 10 ){
        alertTip('最多只能添加十项');
    }else {
    var html='<tr class="son-tr"><td><input class="text-input" type="text" id="bus_web_address" name="bus_web_address[]"> <strong class="form-strong">*</strong></td><td><input class="text-input" type="text" id="eshop_name" name="eshop_name[]"> <strong class="form-strong">*</strong></td><td><input class="text-input" type="text" id="bus_scope" name="bus_scope[]"> <strong class="form-strong">*</strong></td><td><img src="/images/minus_sign.gif" style="margin-left:8px;margin-top:5px;position:absolute;cursor: pointer;" onclick="deleteProudt(this)"></td></tr>';
...
function deleteProudt(obj){
    if($('#item_table tr.son-tr').length <= 1 ){
        alertTip('请至少保留一项');
    }else {
...
<!-- 多选 begin -->
<script src="/select-multiple/js/jquery.select-multiple.js" type="text/javascript"></script>
<script type="text/javascript">
$(function (){
    $('#agent').selectMultiple({
        selectableHeader: "<input type='text' id='search-input' class='search-input' autocomplete='true' placeholder='搜索名称或代码试试，该项支持多选。' />",
    ...
    $('#agen-k').selectMultiple({
        selectableHeader: "<div class='custom-header'>请选择代理报关企业，支持多选。<strong class='form-strong'>*</strong></div>",
    });
});
</script>
<!-- 多选 end -->