...
<form action="/merchant/personal-items/edit" method='POST' id='orderForm' class="pageForm required-validate">
	<fieldset>
                ...
                <tr id="error" style="display:none">
                    <td colspan="12" id="product-table-message_tip" class="error">
                        ...
                        <tr>
                            ...
                            <td style="width: 80px;">对应底账料件号</td>
                            <td style="width: 70px;">商品序号</td>
                            <td style="width: 100px;">商品流水号</td>
                            <td style="width: 140px;">海关商品备案编号</td>
                            <td style="width: 60px;">行邮税号</td>
                            <td style="width: 80px;">海关编码</td>
                            <td style="width: 60px;">申报单价</td>
                            <td style="width: 60px;">数量</td>
                            <td style="width: 60px;">币制</td>
                            <td style="width: 120px;">海关品名</td>
                        ...
                        <{if $personItemProductRows}>
                            <{foreach from=$personItemProductRows item=productItem name='pro'}>
                                  <tr class="product-table-return-message product-item" id='tr_<{$smarty.foreach.pro.iteration}>'>
        <td><{$smarty.foreach.pro.iteration}></td>
        <td>
            <input type="text" value="<{$productItem.goods_id}>" class="w80" name="product[<{$smarty.foreach.pro.iteration}>][goods_id]" onblur='showProduct(this)' key="<{$smarty.foreach.pro.iteration}>" />
            <input type="hidden" value="<{$productItem.pimp_id}>" name="product[<{$smarty.foreach.pro.iteration}>][pimp_id]"  id="productItem_<{$smarty.foreach.pro.iteration}>" />
        </td>
        <td>
            <input type="text" value="<{$productItem.g_no}>" class="w120" name="product[<{$smarty.foreach.pro.iteration}>][g_no]" />
        </td>
        <td>
            <input type="text" value="<{$productItem.ciq_g_no}>" class="w100" name="product[<{$smarty.foreach.pro.iteration}>][ciq_g_no]" onblur='checkRepeat(this)' key="<{$smarty.foreach.pro.iteration}>" />
        </td>
        <td>
            <{$productItem.registerID}>
            <input type="hidden" value="<{$productItem.registerID}>" name="product[<{$smarty.foreach.pro.iteration}>][registerID]" />
        </td>
  
        <td>
             <{$productItem.gt_code}>
            <input type="hidden" value="<{$productItem.gt_code}>" name="product[<{$smarty.foreach.pro.iteration}>][gt_code]" />
        </td>
        <td>
           <{$productItem.hs_code}>
            <input type="hidden" value="<{$productItem.hs_code}>" name="product[<{$smarty.foreach.pro.iteration}>][hs_code]" />
        </td>
        <td>
            <input type="text" value="<{$productItem.price}>" name="product[<{$smarty.foreach.pro.iteration}>][price]" class='medium-input' style="width:100% !important;"/>
        </td>
        <td>
            <input type="text" value="<{$productItem.g_qty}>" name="product[<{$smarty.foreach.pro.iteration}>][g_qty]" class='medium-input' style="width:100% !important;"/>
        </td>
        <td>
            <input type="text" value="<{$productItem.curr}>" name="product[<{$smarty.foreach.pro.iteration}>][curr]" class='medium-input' style="width:100% !important;"/>
        </td>

        <td>
            <input type="text" value="<{$productItem.g_name_cn}>" name="product[<{$smarty.foreach.pro.iteration}>][g_name_cn]" />
        </td>

        <td>
            <{$productItem.g_model}>
            <input type="hidden" value="<{$productItem.g_model}>" name="product[<{$smarty.foreach.pro.iteration}>][g_model]" />
        </td>
        <td>
            <input type="text" value="<{$productItem.g_uint}>" name="product[<{$smarty.foreach.pro.iteration}>][g_uint]"  class='medium-input' style="width:100% !important;" style="width:100% !important;"/>
        </td>
        <td>
            <{$productItem.countryName}>
            <input type="hidden" value="<{$productItem.country}>" name="product[<{$smarty.foreach.pro.iteration}>][country]" />
        </td>

        <td>
            <input type="text" value="<{$productItem.qty_1}>" name="product[<{$smarty.foreach.pro.iteration}>][qty_1]" class='medium-input' style="width:100% !important;"/>
        </td>
        <td>
            <input type="text" value="<{$productItem.unit_1}>" name="product[<{$smarty.foreach.pro.iteration}>][unit_1]" class='medium-input'style="width:100% !important;" />
        </td>
        <td>
            <input type="text" value="<{if $productItem.qty_2 neq '0'}><{$productItem.qty_2}><{/if}>" name="product[<{$smarty.foreach.pro.iteration}>][qty_2]" class='medium-input' style="width:100% !important;"/>
        </td>
        <td>
            <input type="text" value="<{$productItem.unit_2}>" name="product[<{$smarty.foreach.pro.iteration}>][unit_2]" class='medium-input' style="width:100% !important;"/>
        </td>

         <td>
             <{if $smarty.foreach.pro.last}>
             <img src="/images/minus_sign.gif" style="margin-left:8px;margin-top:5px;position:absolute;cursor: pointer;" onclick="deleteProudt(this)"/>
             <{/if}>
         </td>
    </tr>
                            <{/foreach}>
		...
		<table class="pageFormContent">
			<tbody>
                <tr>
                    <td class="form_title nowrap text_right">内部清单编号：<input type="hidden" value="<{$personItemRow.pim_code}>" name="pim_code"></td>
                    <td><input class="text-input width140 ui-autocomplete-input" type="text" id="pim_reference_no" name="pim_reference_no" value="<{$personItemRow.pim_reference_no}>" readonly="readonly"></td>
                </tr>
                <tr>
                    ...
                    <td width='245'><select name="declare_ie_port"
                            ...
                            name=w}>
                                <option value='<{$w.ie_port}>' <{if $w.ie_port eq $personItemRow.declare_ie_port}>selected<{/if}>><{$w.ie_port_name}></option>
                            <{/foreach}>
                    ...
                    <td width='245'>
                        <select name="form_type" class="width155">
                            ...
                            name=w}>
                                <option value='<{$w.form_type}>' <{if $personItemRow.form_type eq $w.form_type}>selected<{/if}>><{$w.form_type_name}></option>
                            <{/foreach}>
                        </select>
                ...
                <tr>
                    ...
                    <td width='245'><input name="customer_code" id='customer_code'
                                           class="text-input width140" value="<{$personItemRow.customer_code}>" /> <span><strong>*</strong></span>
                    </td>

                    <td style="text-align: right" width='175'>电商企业名称：</td>
                    <td width='245'><input name="enp_name" id='enp_name'
                                           class="text-input width140" value="<{$personItemRow.enp_name}>" /> <span><strong>*</strong></span>
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td width='245'><input name="ebp_code" id='ebp_code'
                                           class="text-input width140" value="<{$personItemRow.ebp_code}>" /> <span><strong>*</strong></span>
                    </td>

                    <td style="text-align: right" width='175'>电商平台名称：</td>
                    <td width='245'><input name="ebp_name" id='ebp_name'
                                           class="text-input width140" value="<{$personItemRow.ebp_name}>" /> <span><strong>*</strong></span>
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td width='245'>
                        ...
                        <{else}>
                            <input type="text" class="text-input width140" name="storage_customer_code" value="<{$personItemRow.storage_customer_code}>" />
                            <span><strong>*</strong></span>
                        <{/if}>
                    </td>
                    ...
                    <td width='245'>
                        ...
                        <{else}>
                            <input type="text" class="text-input width140" name="storage_name" value="<{$personItemRow.storage_name}>" />
                            <span><strong>*</strong></span>
                        <{/if}>
                    </td>
                </tr>
                <tr>
                    ...
                    <td width='245'>
                         ...
                         <{if ($companyInfo.is_baoguan == 1 ) }>
                            ...
                            <span class="blue"><{$companyInfo.customer_code}></span>
                        <{else}>
                            <input type="text" class="text-input width140" name="agent_customer_code" value="<{$personItemRow.agent_customer_code}>" />
                            <span><strong>*</strong></span>
                        <{/if}>
                    </td>
                    ...
                    <td width='245'>
                        <{if ($companyInfo.is_baoguan == 1 ) }>
                            ...
                            <span class="blue"><{$companyInfo.trade_name}></span>
                        <{else}>
                            <input type="text" class="text-input width140" name="agent_name" value="<{$personItemRow.agent_name}>" />
                            <span><strong>*</strong></span>
                        <{/if}>
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td width='245'>
                        <input type="text" class="text-input width140" name="logistic_customer_code" value="<{$personItemRow.logistic_customer_code}>" />
                    </td>
                    <td style="text-align: right" width='175'>支付企业代码：</td>
                    <td width='245'>
                        <input type="text" class="text-input width140" name="pay_customer_code" value="<{$personItemRow.pay_customer_code}>" />
                        </td>
                </tr>
                ...
                <tr>
                    ...
                    <td width='245'><input name="buyer_id" id='buyer_id'
                                           class="text-input width140" value="<{$personItemRow.buyer_id}>" /> <span><strong>*</strong></span>
                    </td>
                    <td style="text-align: right" width='175'>订购人姓名：</td>
                    <td width='245'><input name="buyer_name" id='buyer_name'
                                           class="text-input width140" value="<{$personItemRow.buyer_name}>" /> <span><strong>*</strong></span>
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td width='245'><input name="reference_no" id='reference_no'
                                           class="text-input width140" value="<{$personItemRow.order_reference_no}>" readonly="readonly" /> <span><strong>*</strong></span>
                    </td>
                    <td style="text-align: right" width='175'><{t}>wb_code<{/t}>：</td>
                    <td width='245'><input name="log_no" id='log_no'
                                           class="text-input width140" value="<{$personItemRow.log_no}>" readonly="readonly" /> <span><strong>*</strong></span>
                    </td>
                </tr>

				<tr>
					<td style="text-align: right" width='175'><{t}>po_code<{/t}>：</td>
					<td width='245'><input name="pay_no" id='pay_no'
						class="text-input width140" value="<{$personItemRow.pay_no}>" readonly="readonly"/> <span><strong>*</strong></span>
					</td>
                    ...
                    <td width='245'>
                        <select name="wrap_type" id='wrap_type' class="text-input width155">
                            ...
                            name=w}>
                                <option value='<{$w.wrap_type}>' <{if $personItemRow.wrap_type eq $w.wrap_type}>selected<{/if}>><{$w.wrap_type_name}></option>
                            <{/foreach}>
                        </select>
                         <span><strong>*</strong></span>
                    </td>
				...
				<tr>
					...
					<td width='245'><select name="ie_port" id='ie_port'
						class="text-input width155">
							<option value="">-Select-</option> <{foreach from=$iePorts item=w
							name=w}>
							<option value='<{$w.ie_port}>' <{if $personItemRow.ie_port eq $w.ie_port}>selected<{/if}>><{$w.ie_port_name}></option>
							<{/foreach}>
					</select> <span><strong>*</strong></span></td>
                    <td style="text-align: right" width='175'><{t}>AccessPortTransport<{/t}>：</td>
                    <td width='245'><select class="text-input width155"
                                            id="traf_mode" name="traf_mode"> 
											<option value="">-Select-</option>
											<{foreach from=$traf
                            item=c name=c}>
                                <option value='<{$c.tfm_id}>'<{if $personItemRow.traf_mode==$c.tfm_id}>selected<{/if}>><{$c.traf_mode_name}></option> <{/foreach}>
                        </select> <span><strong>*</strong></span></td>
				</tr>
				...
				<tr>
                        ...
                        <select name="ship_trade_country" class="text-input width155">
                            ...
                            name=c}>
                                <option value='<{$c.country_id}>'<{if
                                      $personItemRow.ship_trade_country_id==$c.country_id}>
					...
					<td width='245'><input name="ship_name" id='ship_name'
                                                               class="text-input width140" value="<{$personItemRow.ship_name}>" /> <span><strong>*</strong></span>
					</td>
				</tr>
                <tr>
                    <td style="text-align: right" width='175'>发件人城市：</td>
                    <td width='245'>
                        <input name="ship_city" class="text-input width140" value='<{$personItemRow.ship_city}>'>
                    </td>
                    <td style="text-align: right" width='175'>报关员：</td>
                    <td width='245'>
                        <input name="declare_no" class="text-input width140" value="<{$personItemRow.declare_no}>">
                    </td>
                </tr>
				...
				<tr>
					...
					<td width='245'>
                        <select name="outset_country_id" class="text-input width155">
                            ...
                            name=c}>
                                <option value='<{$c.country_id}>'<{if
                                       $personItemRow.outset_country_id==$c.country_id}>
                                selected<{/if}>><{$c.country_code}> <{$c.country_name}></option>
                            <{/foreach}>
                        </select>
                        <span><strong>*</strong></span>
					</td>
					<td style="text-align: right" width='175'><{t}>aim_country_name<{/t}>：</td>
					<td width='245'><select name="aim_country_name"
						id='aim_country_name' class="text-input width155">
							...
							name=c}>
							<option value='<{$c.country_id}>'<{if
								$personItemRow.aim_country_id==$c.country_id}>
								selected<{/if}>><{$c.country_code}> <{$c.country_name}></option>
							<{/foreach}>
					</select> <span><strong>*</strong></span></td>
				</tr>
				...
				<tr>
					...
					<td width='245'><input name="receive_name" id='receive_name'
                                                               class="text-input width140" value="<{$personItemRow.receive_name}>" /> <span><strong>*</strong></span>
					</td>
					<td style="text-align: right" width='175'><{t}>tel_of_consignee<{/t}>：</td>
					<td width='245'><input name="receive_telphone"
						id='receive_telphone' class="text-input width140" value="<{$personItemRow.receive_telphone}>" /> <span><strong>*</strong></span>
					</td>
				</tr>
				<tr>
					...
					<td width='245'><select name="receive_country_name"
						id='receive_country_name' class="text-input width155">
							...
							name=c}>
							<option value='<{$c.country_id}>'<{if
								$personItemRow.receive_country_id==$c.country_id}>
								selected<{/if}>><{$c.country_code}> <{$c.country_name}></option>
							<{/foreach}>
					</select> <span><strong>*</strong></span></td>
					<td style="text-align: right" width='175'><{t}>province<{/t}>/<{t}>Area<{/t}>：</td>
					<td width='245'><input name="receive_state" id='receive_state'
                                                               class="text-input width140" value="<{$personItemRow.receive_state}>" /> <span><strong>*</strong></span>
					</td>
				</tr>
				<tr>
					<td style="text-align: right" width='175'><{t}>city<{/t}>：</td>
					<td width='245'><input name="receive_city" id='receive_city'
                                                               class="text-input width140" value="<{$personItemRow.receive_city}>" /> <span><strong>*</strong></span>
					</td>
					<td style="text-align: right" width='175'><{t}>receive_id_number<{/t}>：</td>
					<td width='245'><input name="receive_id_number"
						id='receive_id_number' class="text-input width140" value="<{$personItemRow.receive_id_number}>" /> <span><strong>*</strong></span>
					</td>
				</tr>
                <tr>
                    <td style="text-align: right" width='175'>录入单位：</td>
                    <td width='245'><input name="input_company" id='input_company'
                                           class="text-input width140" value="<{$personItemRow.input_company}>" /> <span><strong>*</strong></span>
                    </td>
                    <td style="text-align: right" width='175'>单位地址：</td>
                    <td width='245'><input name="agent_address"
                                           id='agent_address' class="text-input width140" value="<{$personItemRow.agent_address}>" /> <span><strong>*</strong></span>
                    </td>
                </tr>
                <tr>
                    <td style="text-align: right" width='175'>邮编：</td>
                    <td width='245'><input name="agent_post" id='agent_post'
                                           class="text-input width140" value="<{$personItemRow.agent_post}>" /> <span><strong>*</strong></span>
                    </td>
                    <td style="text-align: right" width='175'>电话：</td>
                    <td width='245'><input name="agent_tel"
                                           id='agent_tel' class="text-input width140" value="<{$personItemRow.agent_tel}>" /> <span><strong>*</strong></span>
                    </td>
                </tr>
                <tr>
                    <td style="text-align: right" width='175'>运费：</td>
                    <td width='245'><input name="freight" id='freight'
                                           class="text-input width140" value="<{$personItemRow.freight}>" />
                    </td>
                    <td style="text-align: right" width='175'>保费：</td>
                    <td width='245'><input name="insure_fee"
                                           id='insure_fee' class="text-input width140" value="<{$personItemRow.insure_fee}>" />
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td width='245'><select name="currency"
                        ...
                        <option value="CNY" <{if $personItemRow.currency eq 'CNY'}>selected<{/if}>>CNY</option>
                    </select> <span><strong>*</strong></span></td>
...
<script id="product-list-success" type="text/html">
    <tr class="product-table-return-message product-item" id='tr_{{key}}'>
        ...
        <td>
            <input type="text" value="{{qty_1}}" name="product[{{key}}][qty_1]" class='medium-input'/>
        </td>
        <td>
            <input type="text" value="{{unit_1}}" name="product[{{key}}][unit_1]" class='medium-input'/>
        </td>
        <td>
            <input type="text" value="{{qty_2}}" name="product[{{key}}][qty_2]" class='medium-input'/>
        </td>
        <td>
            <input type="text" value="{{unit_2}}" name="product[{{key}}][unit_2]" class='medium-input'/>
        </td>
...
function addSubmit(){
    ...
    $.ajax({
        ...
        dataType:"json",
        async:false,
        url:'/merchant/personal-items/edit',
