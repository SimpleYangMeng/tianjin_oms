...
<div style="margin-right: 0px; padding: 6px;" class="content-box nbox_c marB10 product_detail cl">
    <table cellspacing="0" cellpadding="0" class="formtable tableborder" width='100%'>       
        ...
        <tr>
            <th>交易订单号</th>
            <td><{$personItemRow.order_reference_no}></td> 
            <th>运单号</th>
...
<!--         <tr>
        ...
        <tr>            
            ...
            <th>运输方式</th>
            <td><{$personItemRow.traf_mode}>(<{$personItemRow.traf_mode_name}>)</td>
...
<!--         <tr>            
        ...
        <tr>
            <th>外包装类型</th>
            <td><{$personItemRow.wrap_type}>(<{$personItemRow.wrap_type_name}>)</td>
            <th>运费</th>
        ...
        <tr>
            ...
            <th>录入时间</th>
            <td><{$personItemRow.input_date}></td>
        ...
        <tr>
            ...
            <th>海关状态</th>
            <td><{$customsStatus[$personItemRow.customs_status]}></td>
            <th>检验检疫状态</th>
            <td><{$ciqStatus[$personItemRow.ciq_status]}></td> 
        </tr>
        <tr>
            <th>最后更新时间</th>
            <td><{$personItemRow.pim_update_time}></td>
            <th>检疫情况</th>
            <td><{$personItemRow.quarantine}></td>
            <th>查验情况</th>
            <td><{$personItemRow.check}></td>
        </tr>
        <tr>
            <th>备注</th>
            <td colspan="5"><{$personItemRow.note}></td>
        </tr>
        <{if $personItemRow.ciq_reject_reason neq ''}>
        <tr>
            <th>商检错误回执</th>
            <td colspan="5"><{$personItemRow.ciq_reject_reason}></td>
        </tr>
        <{/if}>
    </table>
</div>
