...
<div class="content-box ui-tabs ui-corner-all ui-widget ui-widget-content">
  <div class="content-box-header">
    <h3 style="margin-left:5px"><{t}>DistributorAdd<{/t}></h3>
  </div>
  ...
  <div class="ui-widget" style="margin:10px 0;" id="distributor-tip-info">
    <div style="padding:10px 10px;" class="ui-state-highlight ui-corner-all">
      <p>
        ...
        <strong id="distributor-tip-info-content"><{t}>DistributorAddSuccess<{/t}>，<span class="distributor-back" id="distributor-list-view"><{t}>DistributorListView<{/t}></span></strong>
  ...
  <form method="post" action="/merchant/distributor/add" id="distributor-add-form">
    <table>
      <tr>
        ...
        <td class="form_input">
          <input class="text-input width195" type="text" name="distributor_code" id="distributor-code" value="<{$code|escape:'html'}>" /> <strong>*</strong>
        </td>
      </tr>
      <tr>
      ...
      <tr>
        <td colspan="2">
          <input type="submit" class="button" id="distributor-add-action" value="<{t}>DistributorOperationSave<{/t}>"/>
        </td>
      </tr>
    </table>
  </form>
