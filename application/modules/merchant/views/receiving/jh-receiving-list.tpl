...
<div class="content-box  ui-tabs  ui-corner-all  ui-widget ui-widget-content" >
    <div class="content-box-header">
        <h3 style="margin-left:5px"><{t}>CollectionASNList<{/t}></h3>
        <div class="clear"></div>
    </div>
    <form name="searchASNForm"  method="post" action="/merchant/receiving/listjh" id="pagerForm">
        ...
        <div class="searchBar">
            <table class="left searchbartable" id="searchbox" >
                <tr>
                    <td nowrap="nowrap" width="140" style="text-align: right;"><{t}>ReceiveCode<{/t}>/<{t}>CustomerReference2<{/t}>：</td>
                    <td   nowrap="nowrap"><input class="text-input width140 leftloat" type="text"  name="receiving_code" value="<{if isset($params) && !empty($params)}><{$params['receiving_code_like']}><{/if}>" />
                    ...
                    <td style="text-align: right;"><span  class="advanced_element"><{t}>orderCode<{/t}>/<{t}>TradingOrderNo<{/t}>：</span></td>
                    <td colspan="3"><span  class="advanced_element"><input type="text" class="text-input width140" name="order_code" id='orders_code' value="<{$params.order_code}>"></span></td>					
  
                   
                </tr>
                <tr  class="advanced_element">
                    <td width="16%" style="text-align: right;"><{t}>warehousing_logistics_enterprises<{/t}>：</td>
                    <td width="20%">
                ...
                <tr  class="advanced_element">
                    <td width="16%" style="text-align: right;"><{t}>ASNType<{/t}>：</td>
                    <td width="16%">
                    ...
                    <td style="text-align: right;"><{t}>createDate<{/t}>：</td>
...
<{elseif $params.receiving_status eq '5'}>
<!--<div class="bulk-actions align-left"  style="margin-top: 5px; border-radius: 4px 4px 4px 4px;">
<select name="dropdown" class="text-input width140" id="batchSelect">
    <option value=''><{t}>PleaseSelectOperating<{/t}></option>
    <option value='movedraftjh'><{t}>MoveDraft<{/t}></option>
</select>
    <a class="button" href="#" id="batchSubmit"><{t}>Confirm<{/t}></a>
</div>-->
<{/if}>
                ...
                <{foreach from=$result item=item}>
                    <tr target="pid">
                        ...
                        <td style="text-align:center;">
                            <a class="view" href="/merchant/receiving/detail?ASNCode=<{$item['receiving_code']}>"
                                onclick="parent.openMenuTab('/merchant/receiving/detail?ASNCode=<{$item['receiving_code']}>','<{t}>ASNDetail<{/t}>(<{$item['receiving_code']}>)');return false;" title="<{t}>ASNDetail<{/t}>" ><span><{$item['receiving_code']}></span></a>
                        </td>
					...
					<{else}>						
                            ...
                            <a class="edit" href="/merchant/receiving/create?ASNCode=<{$item['receiving_code']}>"
                              onclick="parent.openMenuTab('/merchant/receiving/create?ASNCode=<{$item['receiving_code']}>','<{t}>editAsn<{/t}>(<{$item['receiving_code']}>)');return false;"   title="<{t}>editAsn<{/t}>" width='800' height='600'><span><{t}>edit<{/t}></span></a>
                            ...
                            <a class="view" href="/merchant/receiving/detail?ASNCode=<{$item['receiving_code']}>"
                                onclick="parent.openMenuTab('/merchant/receiving/detail?ASNCode=<{$item['receiving_code']}>','<{t}>ASNDetail<{/t}>(<{$item['receiving_code']}>)');return false;"  title="<{t}>ASNDetail<{/t}>" width='800' height='600'><span><{t}>view<{/t}></span></a>
                        <{/if}>
						</td>
                    </tr>
                    <{/foreach}>
