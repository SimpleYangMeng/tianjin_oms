<?php
class Table_ProductQcMap
{
    protected $_table = null;

    public function __construct()
    {
        $this->_table = new DbTable_ProductQcMap();
    }
    ...
    public function getByCondition($condition = array(), $type = '*', $pageSize = 0, $page = 1, $orderBy = "")
    {
        ...
        if(isset($condition["pq_detail"]) && $condition["pq_detail"] != ""){
            $select->where("pq_detail = ?",$condition["pq_detail"]);
        }
        /*CONDITION_END*/
        if ('count(*)' == $type) {
