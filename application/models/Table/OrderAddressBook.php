<?php
class Table_OrderAddressBook
{
    protected $_table = null;

    public function __construct()
    {
        $this->_table = new DbTable_OrderAddressBook();
    }
    ...
    {
        return new Table_OrderAddressBook();
    }
     ...
     * @return mixed
     */
    public function update($row, $value, $field = "oab_id")
    {
     ...
     * @return mixed
     */
    public function delete($value, $field = "oab_id")
    {
        $where = $this->_table->getAdapter()->quoteInto("{$field}= ?", $value);
     ...
     * @return mixed
     */
    public function getByField($value, $field = 'oab_id', $colums = "*")
    {
