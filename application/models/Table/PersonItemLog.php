<?php
class Table_PersonItemLog
{
    protected $_table = null;

    public function __construct()
    {
        $this->_table = new DbTable_PersonItemLog();
    }
    ...
    {
        return new Table_PersonItemLog();
    }
    ...
    public function getByCondition($condition = array(), $type = '*', $pageSize = 0, $page = 1, $orderBy = "")
    {
        ...
        if(isset($condition["pil_id"]) && $condition["pil_id"] != ""){
            $select->where("pil_id = ?",$condition["pil_id"]);
        }
