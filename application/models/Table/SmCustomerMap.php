<?php
class Table_SmCustomerMap
{
    protected $_table = null;

    public function __construct()
    {
        $this->_table = new DbTable_SmCustomerMap();
    }
    ...
    {
        return new Table_SmCustomerMap();
    }
     ...
     * @return mixed
     */
    public function update($row, $value, $field = "smc_id")
    {
     ...
     * @return mixed
     */
    public function delete($value, $field = "smc_id")
    {
        $where = $this->_table->getAdapter()->quoteInto("{$field}= ?", $value);
     ...
     * @return mixed
     */
    public function getByField($value, $field = 'smc_id', $colums = "*")
    {
    ...
    public function getByCondition($condition = array(), $type = '*', $pageSize = 0, $page = 1, $orderBy = "")
    {
        ...
        if(isset($condition["smc_discount"]) && $condition["smc_discount"] != ""){
            $select->where("smc_discount = ?",$condition["smc_discount"]);
        }
