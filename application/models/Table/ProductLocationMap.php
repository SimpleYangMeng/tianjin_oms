<?php
class Table_ProductLocationMap
{
    protected $_table = null;

    public function __construct()
    {
        $this->_table = new DbTable_ProductLocationMap();
    }
    ...
    {
        return new Table_ProductLocationMap();
    }
     ...
     * @return mixed
     */
    public function update($row, $value, $field = "plm_id")
    {
     ...
     * @return mixed
     */
    public function delete($value, $field = "plm_id")
    {
        $where = $this->_table->getAdapter()->quoteInto("{$field}= ?", $value);
     ...
     * @return mixed
     */
    public function getByField($value, $field = 'plm_id', $colums = "*")
    {
