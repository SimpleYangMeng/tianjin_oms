<?php
class Table_CustomerApplyBinding
{
    protected $_table = null;

    public function __construct()
    {
        $this->_table = new DbTable_CustomerApplyBinding();
    }
    ...
    {
        return new Table_CustomerApplyBinding();
    }
    ...
    public function getByCondition($condition = array(), $type = '*', $pageSize = 0, $page = 1, $orderBy = "")
    {
        ...
        if(isset($condition["cab_customer_code"]) && $condition["cab_customer_code"] != ""){
            $select->where("cab_customer_code = ?",$condition["cab_customer_code"]);
        }
