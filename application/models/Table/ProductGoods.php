<?php
class Table_ProductGoods
{
    protected $_table = null;

    public function __construct()
    {
        $this->_table = new DbTable_ProductGoods();
    }
     ...
     * @return mixed
     */
    public function update($row, $value, $field = "pg_id")
    {
     ...
     * @return mixed
     */
    public function delete($value, $field = "pg_id")
    {
        $where = $this->_table->getAdapter()->quoteInto("{$field}= ?", $value);
     ...
     * @return mixed
     */
    public function getByField($value, $field = 'pg_id', $colums = "*")
    {
