<?php
class Table_ShipBatchAttribute
{
    protected $_table = null;

    public function __construct()
    {
        $this->_table = new DbTable_ShipBatchAttribute();
    }
    ...
    {
        return new Table_ShipBatchAttribute();
    }
     ...
     * @return mixed
     */
    public function update($row, $value, $field = "sba_id")
    {
     ...
     * @return mixed
     */
    public function delete($value, $field = "sba_id")
    {
        $where = $this->_table->getAdapter()->quoteInto("{$field}= ?", $value);
     ...
     * @return mixed
     */
    public function getByField($value, $field = 'sba_id', $colums = "*")
    {
    ...
    public function getByCondition($condition = array(), $type = '*', $pageSize = 0, $page = 1, $orderBy = "")
    {
        ...
        if(isset($condition["voyage_no"]) && $condition["voyage_no"] != ""){
            $select->where("voyage_no = ?",$condition["voyage_no"]);
        }
