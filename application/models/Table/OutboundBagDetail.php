<?php
class Table_OutboundBagDetail
{
    protected $_table = null;

    public function __construct()
    {
        $this->_table = new DbTable_OutboundBagDetail();
    }
    ...
    {
        return new Table_OutboundBagDetail();
    }
     ...
     * @return mixed
     */
    public function update($row, $value, $field = "obd_id")
    {
     ...
     * @return mixed
     */
    public function delete($value, $field = "obd_id")
    {
        $where = $this->_table->getAdapter()->quoteInto("{$field}= ?", $value);
     ...
     * @return mixed
     */
    public function getByField($value, $field = 'obd_id', $colums = "*")
    {
