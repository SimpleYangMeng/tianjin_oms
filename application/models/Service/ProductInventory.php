<?php
class Service_ProductInventory
{
    /**
     * @var null
     */
    ...
    public static function getJoinProductByCondition($condition = array(), $type = '*', $pageSize = 0, $page = 1, $order = ""){
        $model = self::getModelInstance();
        return $model->getJoinProductByCondition($condition, $type, $pageSize, $page, $order);
    }
