<?php
class Service_CiqApiMessage extends Common_Service
{
    ...
    public static function getModelInstance()
    {
        if (is_null(self::$_modelClass)) {
            self::$_modelClass = new Table_CiqApiMessage();
        }
     ...
     * @return mixed
     */
    public static function update($row, $value, $field = "cam_id")
    {
        $model = self::getModelInstance();
     ...
     * @return mixed
     */
    public static function delete($value, $field = "cam_id")
    {
        $model = self::getModelInstance();
     ...
     * @return mixed
     */
    public static function getByField($value, $field = 'cam_id', $colums = "*")
    {
        $model = self::getModelInstance();
