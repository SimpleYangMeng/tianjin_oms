<?php
class Service_CustomerOtherFee extends Common_Service
{
    /**
     * @var null
     */
    ...
    public static function getModelInstance()
    {
        if (is_null(self::$_modelClass)) {
            self::$_modelClass = new Table_CustomerOtherFee();
        }
    ...
    public static function validator($val)
    {
        ...
        $validateArr[] = array("name" =>EC::Lang('FeeChineseName'), "value" =>$val["fee_id"], "regex" => array("require",));
        $validateArr[] = array("name" =>EC::Lang('customerCode'), "value" =>$val["customer_code"], "regex" => array("require",));
        $validateArr[] = array("name" =>EC::Lang('discount'), "value" =>$val["discount"], "regex" => array("require","positive",));
