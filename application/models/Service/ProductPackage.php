...
class Service_ProductPackage
{
    ...
    public static function validator($val)
    {
        ...
        $validateArr[] = array("name" =>EC::Lang('quantity'), "value" =>$val["pp_quantity"], "regex" => array("require","integer",));
        $validateArr[] = array("name" =>EC::Lang('cost'), "value" =>$val["pp_cost"], "regex" => array("require","integer",));
        $validateArr[] = array("name" =>EC::Lang('price'), "value" =>$val["pp_price"], "regex" => array("require","integer",));
        ...
        $validateArr[] = array("name" =>EC::Lang('length'), "value" =>$val["pp_length"], "regex" => array("require","integer",));
        $validateArr[] = array("name" =>EC::Lang('width'), "value" =>$val["pp_width"], "regex" => array("require","integer",));
        $validateArr[] = array("name" =>EC::Lang('height'), "value" =>$val["pp_height"], "regex" => array("require","integer",));
        $validateArr[] = array("name" =>EC::Lang('weight'), "value" =>$val["pp_weight"], "regex" => array("require","integer",));
