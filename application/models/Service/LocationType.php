...
class Service_LocationType
{
    ...
    public static function validator($val)
    {
        ...
        $validateArr[] = array("name" =>EC::Lang('width'), "value" =>$val["lt_width"], "regex" => array("require","integer",));
        $validateArr[] = array("name" =>EC::Lang('length'), "value" =>$val["lt_length"], "regex" => array("require","integer",));
        $validateArr[] = array("name" =>EC::Lang('height'), "value" =>$val["lt_height"], "regex" => array("require","integer",));
        $validateArr[] = array("name" =>EC::Lang('volume'), "value" =>$val["lt_vol"], "regex" => array("require","integer",));
