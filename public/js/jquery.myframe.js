...
function openMenuTab(url,label,keyid,is_replace){
		...
		if($('#'+keyid+iframeboxSuffix).size()==0){			
			...
			var contentHtml = '<iframe   style="border:#000000 1px solid" allowtransparency="true"  border="1" frameborder="1" width="100%" height="'+documentMinHeight+'" scrolling="no" ' + 'id="'+keyid+iframeboxSuffix+'"' +'name="'+keyid+iframeboxSuffix+'"' +'src="'+url+'"'+'></iframe>';
						 ...
						 if(document.body.scrollHeight){											
							...
							if(typeof(parent.document.all(parent.menuidList[i]+parent.iframeboxSuffix).style)!='undefined'){
								...
								//alert(document.body.scrollHeight+'px');
									...
									//$('#right').height(2550);
									//var a = parent.document.getElementById('right');
									//$(a).height(document.body.scrollHeight);
									//alert(document.body.scrollHeight);
									//alert(parent.document.all('contentRight').style.height);
