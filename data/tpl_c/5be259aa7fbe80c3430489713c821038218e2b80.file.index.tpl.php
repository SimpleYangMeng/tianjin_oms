<?php /* Smarty version Smarty-3.1.13, created on 2014-07-04 09:49:53
         compiled from "/home/apache/www/import/oms/application/modules/default/views/forgetpassword/index.tpl" */ ?>
<?php /*%%SmartyHeaderCode:69553727853b60841593f42-37657681%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '5be259aa7fbe80c3430489713c821038218e2b80' => 
    array (
      0 => '/home/apache/www/import/oms/application/modules/default/views/forgetpassword/index.tpl',
      1 => 1396509264,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '69553727853b60841593f42-37657681',
  'function' => 
  array (
  ),
  'has_nocache_code' => false,
  'version' => 'Smarty-3.1.13',
  'unifunc' => 'content_53b608415c8980_84283951',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_53b608415c8980_84283951')) {function content_53b608415c8980_84283951($_smarty_tpl) {?><div class="grid-780 grid-780-pd fn-hidden fn-clear">
...
<form id="authForm" class="fm-layout" method="post" action="">
	  <fieldset>
                ...
                <p class="form-p">
                    <label class="form-label">图形验证码:                     
                    </label>
                	<input  type="text" class=" text-input validate[required]" id="verify2" name="verify2">
                    <img class="verifyChange2" id="verifyImg2" title="点击以更新验证码" src="/register/verify-code">
                    <strong style="color: #FF0000;"><a class="verifyChange2" href="javascript:void(0);">看不清？换过一个</a></strong>
                    <strong></strong>
                </p>
                <p class="form-p">
