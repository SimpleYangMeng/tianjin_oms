<?php /* Smarty version Smarty-3.1.13, created on 2015-11-16 09:29:22
         compiled from "D:\www\import_oms\branches\tianjin\application\modules\merchant\views\product\add-all.tpl" */ ?>
<?php /*%%SmartyHeaderCode:281856493172821875-53128769%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '71361437bf26c9132a1a0317e53a0cce4d4dd371' => 
    array (
      0 => 'D:\\www\\import_oms\\branches\\tianjin\\application\\modules\\merchant\\views\\product\\add-all.tpl',
      1 => 1446033128,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '281856493172821875-53128769',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_56493172965036_02492064',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_56493172965036_02492064')) {function content_56493172965036_02492064($_smarty_tpl) {?><?php if (!is_callable('smarty_block_t')) include 'D:\\www\\import_oms\\branches\\tianjin\\libs\\Smarty\\plugins\\block.t.php';
...
function _loadImage(serverData) {
    ...
    var imgWrap = $("<div class='imgWrap' style='position:relative;height:140px;'></div>");
	...
	imgWrap.append('<select style="width:100%;" name="imageSelect['+imageCount+'][]"><option value="">请选择</option><option value="1">正面</option><option value="2">侧面</option><option value="3">背面</option><option value="4">标签</option></select><img class="deleteImage" src="/images/icons/icon_square_close.png" style="cursor:pointer;position:absolute;top: 9px;right: 9px;width:14px;height:14px;">');
