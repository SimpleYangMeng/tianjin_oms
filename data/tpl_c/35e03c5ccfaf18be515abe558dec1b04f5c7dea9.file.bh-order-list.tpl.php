<?php /* Smarty version Smarty-3.1.13, created on 2014-07-03 17:57:23
         compiled from "/home/apache/www/import/oms/application/modules/merchant/views/order/bh-order-list.tpl" */ ?>
<?php /*%%SmartyHeaderCode:188151616553b3a2a6667c65-76193219%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '35e03c5ccfaf18be515abe558dec1b04f5c7dea9' => 
    array (
      0 => '/home/apache/www/import/oms/application/modules/merchant/views/order/bh-order-list.tpl',
      1 => 1404381399,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '188151616553b3a2a6667c65-76193219',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.13',
  'unifunc' => 'content_53b3a2a697e4c2_37576665',
  'variables' => 
  array (
    'page' => 0,
    'pageSize' => 0,
...
<?php if ($_valid && !is_callable('content_53b3a2a697e4c2_37576665')) {function content_53b3a2a697e4c2_37576665($_smarty_tpl) {?><?php if (!is_callable('smarty_block_t')) include '/home/apache/www/import/oms/libs/Smarty/plugins/block.t.php';
?><style type="text/css">
...
StockingOrderList<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo smarty_block_t(array(), $_block_content, $_smarty_tpl, $_block_repeat);  } array_pop($_smarty_tpl->smarty->_tag_stack);?>
    ...
    <form name="searchASNForm"  method="post" action="/merchant/order/listbh" id="pagerForm">
...
" name="orders_status" class='status'>
        ...
        <div class="searchBar">
            <table  id ="searchbartable" class="searchbartable" style="width:auto"  >
                <tbody>
                <tr>
...
')"><?php echo $_smarty_tpl->tpl_vars['item']->value['reference_no'];?>
 ...
 KG</td>
					...
					<?php if ($_smarty_tpl->tpl_vars['orders_status']->value=='18'){?>
						...
						已确认
						<?php }elseif($_smarty_tpl->tpl_vars['item']->value['order_status']=='3'){?>
						异常
						<?php }elseif($_smarty_tpl->tpl_vars['item']->value['order_status']=='4'||$_smarty_tpl->tpl_vars['item']->value['order_status']=='5'||$_smarty_tpl->tpl_vars['item']->value['order_status']=='6'||$_smarty_tpl->tpl_vars['item']->value['order_status']=='7'){?>
						已提交
					...
					<?php }else{ ?>
                    <?php if ($_smarty_tpl->tpl_vars['orders_status']->value=='4,5,6,7'){?>
                        <?php if ($_smarty_tpl->tpl_vars['item']->value['intercept_status']=='0'){?>
                        <a onclick="lanjie('<?php echo $_smarty_tpl->tpl_vars['item']->value['order_code'];?>
')" >拦截</a>
                        <?php }?>
                    <?php }?>
