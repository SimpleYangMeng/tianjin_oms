<?php /* Smarty version Smarty-3.1.13, created on 2014-07-10 09:09:59
         compiled from "/home/apache/www/import/oms/application/modules/merchant/views/distributor/add.tpl" */ ?>
<?php /*%%SmartyHeaderCode:207279022453bde7e7361404-84367567%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'c266a585cc98977b12215f8d331b07f47e6089bc' => 
    array (
      0 => '/home/apache/www/import/oms/application/modules/merchant/views/distributor/add.tpl',
      1 => 1404894866,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '207279022453bde7e7361404-84367567',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_53bde7e73e4265_86162144',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_53bde7e73e4265_86162144')) {function content_53bde7e73e4265_86162144($_smarty_tpl) {?><?php if (!is_callable('smarty_block_t')) include '/home/apache/www/import/oms/libs/Smarty/plugins/block.t.php';
?><style type="text/css">
...
DistributorAddSuccess<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo smarty_block_t(array(), $_block_content, $_smarty_tpl, $_block_repeat);  } array_pop($_smarty_tpl->smarty->_tag_stack);?>
...
DistributorListView<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo smarty_block_t(array(), $_block_content, $_smarty_tpl, $_block_repeat);  } array_pop($_smarty_tpl->smarty->_tag_stack);?>
  ...
  <form method="post" action="/merchant/distributor/add" id="distributor-add-form">
    <table>
      <tr>
...
：</td>
        <td class="form_input">
          <input class="text-input width195" type="text" name="distributor_code" id="distributor-code" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['code']->value, ENT_QUOTES, 'UTF-8', true);?>
" /> <strong>*</strong>
        </td>
      </tr>
      <tr>
...
DistributorStatusDisabled<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo smarty_block_t(array(), $_block_content, $_smarty_tpl, $_block_repeat);  } array_pop($_smarty_tpl->smarty->_tag_stack);?>
      ...
      <tr>
        <td colspan="2">
          <input type="submit" class="button" id="distributor-add-action" value="<?php $_smarty_tpl->smarty->_tag_stack[] = array('t', array()); $_block_repeat=true; echo smarty_block_t(array(), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
